...
describe("URL policy", () => {
  ...
  it("normalizes same-origin URLs and removes fragments", () => {
    ...
    expect(normalizeUrl("https://example.com:443/products#details", origin)).toBe("https://example.com/products");
  ...
  it("deduplicates and caps sitemap URLs while preserving order", () => {
    const origin = new URL("https://example.com");
    expect(
      filterSitemapUrls(["https://example.com/a#x", "https://example.com/a", "https://example.com/b"], origin, 2),
